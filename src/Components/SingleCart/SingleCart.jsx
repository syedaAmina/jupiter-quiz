...
const SingleCart = ({ cart }) => {
  ...
  return (
    <div>
      <div className="bg-gray-100 border-2 mb-10 w-96 h-96 max-w-xs rounded-md shadow-md dark:bg-gray-200 object-cover dark:text-gray-100">
        ...
        <div className="mt-5 btn flex p-3 w-full justify-between text-2xl text-black">
          ...
          <Link to={`SingleCart/${id}`}>
            <button className="text-center p-2 border-2	rounded-lg hover:bg-green-500  bg-yellow-500">Start Practice</button>
          </Link>
        </div>
      </div>
    </div>
